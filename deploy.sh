...
sudo docker build -t 192.168.242.91:5000/nginx:${NOW_TIME} .
sudo docker push 192.168.242.91:5000/nginx:${NOW_TIME}
cd ${WORK_HOME}
}
...
sudo docker build -t 192.168.242.91:5000/tomcat:${NOW_TIME} .
sudo docker push 192.168.242.91:5000/tomcat:${NOW_TIME}
cd ${WORK_HOME}
}
